...
### **Tugas Mahasiswa**
Gunakan DataFrame di atas dan lakukan langkah berikut di Google Colab:

1. Tambahkan kolom baru `Nilai_Akhir`:

   ```
   Nilai_Akhir = (0.4 * Nilai_Tugas) + (0.6 * Nilai_UAS)
   ```

2. Hitung **rata-rata** dan **nilai maksimum** dari `Nilai_Akhir`.

3. Filter mahasiswa dengan `Nilai_Akhir >= 85`.

4. Ubah urutan kolom menjadi:

   ```
   ['Nama', 'Jurusan', 'Umur', 'Nilai_Tugas', 'Nilai_UAS', 'Nilai_Akhir']
   ```

5. Tampilkan tabel tanpa index menggunakan:
